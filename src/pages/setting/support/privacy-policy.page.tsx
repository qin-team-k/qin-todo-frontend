...
const PrivacyPolicy: NextPage = () => {
  ...
  return (
    <div>
      <SettingHeader text="プライバシーポリシー" href="/setting/edit" />
      <Layout center="account">
        <div className="mb-20 space-y-8">
          ...
          <div>
            <h3>本人確認のため サービスの提供のため</h3>
            <h3>ユーザーに対する必要事項の通知のため</h3>
            <h3>各種お問い合わせ対応、ユーザーサポートのため</h3>
            <h3>個人情報の適正管理</h3>
            <h3>
          ...
          <div>
            <h2>ユーザーに事前の同意を得た場合</h2>
            <h3>
              弊社の業務の一部を受託した業務委託会社に対し、当該委託業務遂行のために必要な範囲で提供、開示する場合
            </h3>
            <h3>法令により開示を求められた場合</h3>
            <h3>裁判所、警察等の公的機関から開示を求められた場合</h3>
            <h3>
          ...
          <div>
            ...
            <h3>窓口： Qin 運営チーム（support@qin.salon）</h3>
          </div>
          <div>
...
export default withUser(PrivacyPolicy);
