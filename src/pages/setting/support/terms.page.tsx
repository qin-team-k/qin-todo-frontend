    ...
    <div>
      ...
      <Layout center="account">
        <div className="mb-20 space-y-8">
          <h2>
            本規約は、合同会社Qin（以下「弊社」とします）が提供するブログサービス『QinTodo』（以下「本サービス」とします）について、その利用者との間に適用されるものです。
          </h2>
          ...
          <div>
            ...
            <h2>第９条 知的財産権の帰属</h2>
            <h3>
              本サービスに関する特許権、実用新案権、意匠権、著作権等（著作権法第27
              条及び第
              28条に規定する権利を含む。以下本条において総称して「知的財産権」といいます）は、本サービス又は正当な権利を有する第三者に帰属します。
            </h3>
